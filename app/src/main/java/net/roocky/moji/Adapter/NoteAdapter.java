...
public class NoteAdapter extends BaseAdapter {
    ...
    public NoteAdapter(Context context, String[] columns, String selection, String[] selectionArgs, int count) {
        super(context, "note", columns, selection, selectionArgs, count);
    }
